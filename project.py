...
APPLICATION_NAME = "Dog Store Menu Application"
...
# JSON APIs to view ItemType Information
@app.route('/item/<int:item_id>/menu/JSON')
def itemMenuJSON(item_id):
...
@app.route('/item/<int:item_id>/menu/<int:menu_id>/JSON')
...
def newItem():
    ...
    if request.method == 'POST':
        ...
        session.add(newItem)
        flash('New ItemType %s Successfully Created' % newItem.name)
        session.commit()
...
def editItem(item_id):
    ...
    if request.method == 'POST':
        if request.form['name']:
            ...
            flash('ItemType Successfully Edited %s' % editedItem.name)
            return redirect(url_for('showItems'))
    else:
        return render_template('editItemType.html', item=editedItem)
...
def deleteItem(item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleteItemType.html', item=itemToDelete)

# Show a item menu


@app.route('/item/<int:item_id>/')
@app.route('/item/<int:item_id>/menu/')
def showMenu(item_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        return render_template('publicmenu.html', items=items, item=item, creator=creator)
    else:
        return render_template('menu.html', items=items, item=item, creator=creator)


# Create a new menu item
@app.route('/item/<int:item_id>/menu/new/', methods=['GET', 'POST'])
...
@app.route('/item/<int:item_id>/menu/<int:menu_id>/edit', methods=['GET', 'POST'])
def editMenuItem(item_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('editmenuitem.html', item_id=item_id, menu_id=menu_id, item=editedItem)
